    ...
    <el-card>
      <div style="display:flex;justify-content:space-between;">
        <el-form ref="ruleForm" :model="tableInfo" inline>
          <el-form-item>
            <el-input v-model="tableInfo.projectName" placeholder="机构名称查询" clearable style="width:250px;" />
          </el-form-item>
          <el-form-item>
            <el-input v-model="tableInfo.companyName" placeholder="手机号码查询" clearable style="width:250px;" />
          </el-form-item>
          <el-form-item>
    ...
    <el-dialog
      ...
      <el-form ref="addRef" :model="addForm" label-width="100px">
        <el-form-item label="机构类型">
          <el-select v-model="addForm.region" placeholder="请选择" class="width100">
